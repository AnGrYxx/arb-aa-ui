...
function getAaBalances(params2) {
    ...
    .then(data => {
        ...
        if (key1[0] === "PVL22DMGM57FOYKJRPKMQBFM2BUSJLDU" || key1[0] === "Y3NP6UMNFMA6DU2DGPJN4HB65KHKVAKR" || key1[0] === "YSGAUS4DWUORJMV3TEZXPCAEFCT4FGO3" || key1[0] === "USKWYTYD4NKBIOGPFGROG5NNTQQLISYB" || key1[0] === "6DV4SOBQ5XCC44242HTRXJMRQUXYZFSI" || key1[0] === "6KGD2SIKEIMWKUWC5E5265JKMMZHFWF2") {
            // if t1/reserve arb
            var base_stable = data[0][key1] ? data[0][key1].base.stable / 1000000000 : 0;
            var base_pending = data[0][key1] ? data[0][key1].base.pending / 1000000000 : 0;
            var base_total = base_stable + base_pending;
            var growthToken_pending = data[0][key1][key2[1]] ? data[0][key1][key2[1]].pending / 1000000000 : 0;
            var growthToken_stable = data[0][key1][key2[1]] ? data[0][key1][key2[1]].stable / 1000000000 : 0;
            ...
            if (!data[0][key1][key2[2]]) {
                ...
                var interest_pending = data[0][key1][key2[1]] ? data[0][key1][key2[1]].pending / interestDecimals : 0;
                var interest_stable = data[0][key1][key2[1]] ? data[0][key1][key2[1]].stable / interestDecimals : 0;
                ...
                var interest_pending = data[0][key1][key2[2]] ? data[0][key1][key2[2]].pending / interestDecimals : 0;
                var interest_stable = data[0][key1][key2[2]] ? data[0][key1][key2[2]].stable / interestDecimals : 0;
                var interest_total = interest_pending + interest_stable;
                var stable_pending = data[0][key1][key2[3]] ? data[0][key1][key2[3]].pending / interestDecimals : 0;
                var stable_stable = data[0][key1][key2[3]] ? data[0][key1][key2[3]].stable / interestDecimals : 0;
